...
DR_EXPLAIN.data_menu = {
    // menu
    DREX_NODE_NAMES: ["Title","1. Kubo Shiori Pics","2. Three Sisters","A topic without number","1.1. Kubochan 1","1.2. Kubochan 2"],
    DREX_NODE_LINKS: ["index.htm","kubo_shiori_pics.htm","three_sisters.htm","a_topic_without_number.htm","kubochan_1.htm","kubochan_2.htm"],
    DREX_NODE_CHILD_START: [1,4,6,6,6,6],
    DREX_NODE_CHILD_END: [4,6,6,6,6,6],
    DREX_MENU_TYPE: 2,
